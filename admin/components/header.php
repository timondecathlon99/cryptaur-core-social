...
<!DOCTYPE html>
  <head>
	...
	<link rel='icon' href='<?=$domain?><?=$theme->meta_icon()?>'>
    <meta property='og:image' content='<?=$domain?><?=$theme->meta_icon()?>'>
    <meta property='og:title' content='<?=$theme->meta_title()?>'>
    <meta property='og:site_name' content='<?=$theme->meta_title()?>'>
